...
//class StandardVolumeRampStrategy {
//    
//    // MARK: - Constants
//    
...
//        let experienceAdjusted = adjustForExperience(baselineSets, experience: experience)
//        
...
//        let (minReps, maxReps) = getRepRange(for: goal, experience: experience)
//        
//        // Calculate intensity based on goal and experience
//        let intensity = getIntensity(for: goal, experience: experience)
//        
...
//    private func adjustForExperience(_ baseSets: Int, experience: TrainingExperience) -> Int {
//        let adjustment: ExperienceAdjustment
//        
//        // Convert trainingAge to the appropriate enum
//        if experience.trainingAge < 1 {
//            adjustment = .beginner
//        } else if experience.trainingAge < 3 {
...
//    func getRepRange(for goal: TrainingGoal, experience: TrainingExperience) -> (Int, Int) {
...
//    private func getIntensity(for goal: TrainingGoal, experience: TrainingExperience) -> Double {
//        switch goal {
//        case .hypertrophy:
//            if experience.trainingAge < 1 {
